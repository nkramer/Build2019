...
namespace Microsoft.Teams.Samples.HelloWorld.Web
{
    public partial class Startup
    {
        ...
        public static string appId = ConfigurationManager.AppSettings["ida:GraphAppId"];
        public static string appSecret = ConfigurationManager.AppSettings["ida:GraphAppSecret"];
        public static string redirectUri = ConfigurationManager.AppSettings["ida:GraphRedirectUri"];
