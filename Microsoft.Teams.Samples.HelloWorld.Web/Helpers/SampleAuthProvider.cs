...
namespace ContosoAirlines.Helpers
{
    public sealed class SampleAuthProvider : IAuthProvider
    {
        ...
        private static string appId = ConfigurationManager.AppSettings["ida:GraphAppId"];
        private static string appSecret = ConfigurationManager.AppSettings["ida:GraphAppSecret"];
        private static string redirectUri = ConfigurationManager.AppSettings["ida:GraphRedirectUri"];
        private static string scopes = ConfigurationManager.AppSettings["ida:GraphScopes"];
